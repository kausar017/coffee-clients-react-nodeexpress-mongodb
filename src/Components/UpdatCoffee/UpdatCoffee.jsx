    ...
    return (
        <div className="container mx-auto  bg-[#F4F3F0] py-10">
            <div className=" text-center max-w-[800px] mx-auto">
                <h1 className="text-4xl font-rancho text-[#331A15] font-bold">Update Existing Coffee Details</h1>
                ...
                <form onSubmit={handalSubmit} className="">
                    ...
                    <div>
                        ...
                        <div className="px-20 py-5">
                            <button className="btn w-full bg-[#D2B48C] border-2 border-[#331A15] text-[#331A15] font-rancho">Update Coffee Details</button>
                        </div>
                    </div>
                </form>
            </div>
